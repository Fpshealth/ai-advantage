...
Before: {time or volume today} → After: {estimate} · KPI: {time saved / quality / revenue / error rate}

**Welche Systeme sind involviert?** (EN: *Which systems are involved?*)
{Tools, required access, sensitive data yes/no.}

**Wer wird oder soll das Projekt realisieren?** (EN: *Who will or should realise the project?*)
{Role, what already exists (SOP / process documentation / skill), the first step.}
